...
library(C50)
options(scipen=999)
setwd("D:\\D\\Rscript\\Reporting_GUI\\")
...
source("D:\\D\\Rscript\\Reporting_GUI\\PkgLoader.R")
source("D:\\D\\Rscript\\Reporting_GUI\\GetDatasetList.R")
source("D:\\D\\Rscript\\Reporting_GUI\\GetColumnsType.R")
source("D:\\D\\Rscript\\Reporting_GUI\\DataSummary.R")
source("D:\\D\\Rscript\\Reporting_GUI\\Preprocess.R")
source("D:\\D\\Rscript\\Reporting_GUI\\StatisticsTest.R")
source("D:\\D\\Rscript\\Reporting_GUI\\Clustering.R")
source("D:\\D\\Rscript\\Reporting_GUI\\Classification.R")
source("D:\\D\\Rscript\\Reporting_GUI\\Visualize.R")
